...
starts during an **8:00-11:00 AM ET (inclusive)** window. If the guard blocks a scheduled run, the
...
# Scheduled runs fail visibly unless they begin between 8:00-11:00 AM ET (inclusive).
